...
const main = () => {
  ...
  import(settingFilePath)
    .then((setting) => {
      const soundPlayer = new SoundPlayer(setting.default.DISCORD.WAIT_TIME);
      ...
      console.log(
        `ボイスチャンネル: ${setting.default.DISCORD.TARGET_VOICE_ROOM}, チャットチャンネル: ${setting.default.DISCORD.TARGET_CHAT_ROOM}`
      );
